...
import { TOKEN_2022_PROGRAM_ID, createThawAccountInstruction } from '@solana/spl-token'
...
task('lz:solana:unblacklist', 'Unblacklists a user from the token')
    ...
    .addParam('squadsAddr', 'The squads address to use for the unblacklist', undefined, devtoolsTypes.string, false)
